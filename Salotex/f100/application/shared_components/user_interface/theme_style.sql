...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(86160181205944667)
,p_theme_id=>42
,p_name=>'Vita (black)'
,p_is_public=>true
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(86164959669887491)
,p_theme_id=>42
,p_name=>'Vita (black1)'
,p_is_public=>true
,p_is_accessible=>true
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(88749970750691699)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(109838027930775843)
,p_theme_id=>42
