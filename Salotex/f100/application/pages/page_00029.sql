...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90358999409297750)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90368505800297766)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(90368900895297766)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(90368505800297766)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(90370518075297769)
...
,p_security_scheme=>wwv_flow_imp.id(86410638168115597)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(90370940805297769)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(90371311224297770)
...
,p_security_scheme=>wwv_flow_imp.id(86410422720114898)
,p_database_action=>'INSERT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65607243648560240)
,p_name=>'P29_LINK_MAPA'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(90358999409297750)
,p_item_source_plug_id=>wwv_flow_imp.id(90358999409297750)
,p_prompt=>'Link mapa'
,p_source=>'LINK_MAPA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90359413356297751)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90359802802297752)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90360268016297753)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90361865544297755)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90362247491297756)
,p_name=>'P29_LATITUD'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(90358999409297750)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90362605218297756)
,p_name=>'P29_LONGITUD'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(90358999409297750)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90363065133297757)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90363407041297758)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90363791897297759)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90364179233297759)
,p_name=>'P29_ESTADO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>140
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(98785851533445342)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(98785966397445343)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(98786108803445344)
,p_name=>'P29_DISTRITO'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(90358999409297750)
,p_prompt=>'Distrito'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(90369016948297766)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(90368900895297766)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(90369828016297768)
,p_event_id=>wwv_flow_imp.id(90369016948297766)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(90372151922297771)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(90358999409297750)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(90372568708297771)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(90371679268297770)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(98769582533674446)
