...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(121758266793017944)
,p_plug_name=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(121758551990017947)
,p_name=>'P0_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(121758266793017944)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(121758701612017948)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(121758784561017949)
,p_event_id=>wwv_flow_imp.id(121758701612017948)
,p_event_result=>'TRUE'
