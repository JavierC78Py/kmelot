...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(86905180031044898)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(86908611817044902)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(86908946079044902)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(86908611817044902)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(86910322893044904)
...
,p_security_scheme=>wwv_flow_imp.id(86934489647364032)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(86910801492044904)
...
,p_button_condition=>'P66_ID_USU_P_EXP'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(86934313452363013)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(86911152276044904)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86905445134044898)
,p_name=>'P66_ID_USU_P_EXP'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(86905180031044898)
,p_item_source_plug_id=>wwv_flow_imp.id(86905180031044898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86905843702044899)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86906542999044900)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86906943699044901)
,p_name=>'P66_ESTADO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(86909097198044902)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(86908946079044902)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(86909871135044904)
,p_event_id=>wwv_flow_imp.id(86909097198044902)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(86911978181044905)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(86905180031044898)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(86912327983044905)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(86911569161044904)
,p_process_sequence=>10
