...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84905227896601973)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84909826432601985)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84919809757602027)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84910292825601985)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(84909826432601985)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84911898945601989)
...
,p_security_scheme=>wwv_flow_imp.id(86638423379978253)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84912281717601989)
...
,p_button_condition=>'P33_ID_VACA_DISPONIBLE'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(86638084867975280)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84912709138601990)
...
,p_security_scheme=>wwv_flow_imp.id(86638317188976477)
,p_database_action=>'INSERT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84905718650601975)
,p_name=>'P33_ID_VACA_DISPONIBLE'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(84905227896601973)
,p_item_source_plug_id=>wwv_flow_imp.id(84905227896601973)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84906056723601980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84906437459601982)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84906850346601983)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84907252046601983)
,p_name=>'P33_ESTADO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84907694907601983)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(84910333297601985)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(84910292825601985)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(84911155876601987)
,p_event_id=>wwv_flow_imp.id(84910333297601985)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(84913453602601990)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(84905227896601973)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(84913858208601991)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(84913042023601990)
,p_process_sequence=>10
