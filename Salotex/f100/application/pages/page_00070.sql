...
,p_required_role=>wwv_flow_imp.id(87571208496215958)
,p_dialog_chained=>'N'
,p_protection_level=>'C'
,p_page_component_map=>'02'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(34543642258185322)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(87523861286547650)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(87548008023484942)
,p_name=>unistr('Hist\00F3rico de precios')
,p_parent_plug_id=>wwv_flow_imp.id(87523861286547650)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87548076404484943)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87548146451484944)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87548270006484945)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87548363027484946)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87548505593484947)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87548539957484948)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(87548693462484949)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(87528690177547671)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(87529096134547671)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(87528690177547671)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(87530475492547674)
...
,p_security_scheme=>wwv_flow_imp.id(87571731148218990)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(87530906345547674)
...
,p_button_condition=>'P70_ID_PRECIO_VENTA'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(87571415053217413)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(87531307326547674)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(34543303805185319)
,p_name=>'P70_PRO_ID_PRODUCTO_ART'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(87523861286547650)
,p_item_source_plug_id=>wwv_flow_imp.id(87523861286547650)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(34543766506185323)
,p_name=>'P70_P_TIPO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(34543642258185322)
,p_prompt=>'P Tipo'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87524174052547652)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87524546241547658)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87525013140547660)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87525717921547666)
,p_name=>'P70_PRECIO'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(87523861286547650)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87526090496547666)
,p_name=>'P70_USUARIO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87526464386547667)
,p_name=>'P70_FECHA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(87547904447484941)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(87529133294547671)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(87529096134547671)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(87529920995547674)
,p_event_id=>wwv_flow_imp.id(87529133294547671)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(87549100204484953)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(87549150178484954)
,p_event_id=>wwv_flow_imp.id(87549100204484953)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(87548008023484942)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(87532065002547678)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(87523861286547650)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(87532463015547678)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(87531718472547675)
,p_process_sequence=>10
