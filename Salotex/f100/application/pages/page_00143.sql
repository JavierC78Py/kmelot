...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(104478195506469935)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(104479040419469939)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(104478195506469935)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>3371237801798025892
,p_plug_display_sequence=>10
,p_plug_display_point=>'SMART_FILTERS'
,p_plug_source_type=>'NATIVE_SMART_FILTERS'
,p_filtered_region_id=>wwv_flow_imp.id(104478876967469939)
,p_ai_enabled=>false
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(104478876967469939)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65762549774591601)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65763019243591602)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65763351422591602)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65763792543591602)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65764176959591602)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65764567964591602)
,p_query_column_id=>6
,p_column_alias=>'TYPE'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65765011174591603)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65765413313591603)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65765737555591603)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65766183515591603)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65766550320591604)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65766931586591604)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65767393117591604)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65767752596591604)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65768220619591604)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(65768602358591605)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(104336411243883542)
,p_name=>'P143_ID_RESERVA'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(104479040419469939)
,p_prompt=>'Id reserva'
,p_source=>'ID_PK'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(104487331194469964)
,p_name=>'P143_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(104479040419469939)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(104487708101469968)
