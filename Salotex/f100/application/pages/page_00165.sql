...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(39625816293563026)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(39935291521313955)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(39939904795313973)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(39940382456313974)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(39939904795313973)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(39941734868313976)
...
,p_security_scheme=>wwv_flow_imp.id(40162342242528267)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(39942114593313976)
...
,p_button_condition=>'P165_ID_COSTEO'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(40161906262525980)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(39942545229313977)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(39626335803563031)
,p_name=>'P165_P_CANTIDAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(39625816293563026)
,p_prompt=>'P Cantidad'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(39935568446313959)
,p_name=>'P165_ID_COSTEO'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(39935291521313955)
,p_item_source_plug_id=>wwv_flow_imp.id(39935291521313955)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(39935983668313962)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(39936605016313971)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(39937344921313972)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(39938063788313972)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(39940442765313974)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(39940382456313974)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(39941299016313976)
,p_event_id=>wwv_flow_imp.id(39940442765313974)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(39626425109563032)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(39943373288313978)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(39935291521313955)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(39943740376313978)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(39942970505313978)
,p_process_sequence=>10
