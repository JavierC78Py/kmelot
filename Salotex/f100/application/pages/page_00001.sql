...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(81868425861726570)
,p_plug_name=>'Imagen'
,p_region_name=>'IMG'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(87107322153750040)
,p_plug_name=>'Salotex'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65342177678574949)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(81868582044726571)
,p_name=>'P1_URL_IMG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(81868425861726570)
,p_prompt=>'Url Img'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20336471888072402)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20336537159072403)
,p_event_id=>wwv_flow_imp.id(20336471888072402)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(65342317825574950)
