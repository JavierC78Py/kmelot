...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84760737546599806)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84765250242599810)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84775121805599821)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84765684304599811)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(84765250242599810)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84767227597599812)
...
,p_security_scheme=>wwv_flow_imp.id(86632063781911655)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84767705731599812)
...
,p_button_condition=>'P41_ID_JEFATURA'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(86631693763909506)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84768076605599812)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84157663597868858)
,p_name=>'P41_NRO_CELULAR'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(84760737546599806)
,p_item_source_plug_id=>wwv_flow_imp.id(84760737546599806)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84761026894599807)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84761513792599808)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84761820961599808)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84762248226599808)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84762664120599809)
,p_name=>'P41_NIVEL'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>50
...
,p_lov=>'.'||wwv_flow_imp.id(84778145189617462)||'.'
,p_cHeight=>1
,p_colspan=>3
,p_field_template=>1609121967514267634
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(84763032464599809)
,p_name=>'P41_ESTADO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>70
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(84765777228599811)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(84765684304599811)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(84766594280599811)
,p_event_id=>wwv_flow_imp.id(84765777228599811)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(84768870541599813)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(84760737546599806)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(84769292445599813)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(84768425958599812)
,p_process_sequence=>10
