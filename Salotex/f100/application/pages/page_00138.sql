...
,p_required_role=>wwv_flow_imp.id(46273282836972685)
,p_protection_level=>'C'
,p_page_component_map=>'18'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(45742057650368428)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(45742161703368429)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45742212023368430)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45742301303368431)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45742418327368432)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45742592751368433)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45742698468368434)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45742789884368435)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45742893670368436)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45743072874368438)
...
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(34796232850928406)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45743147973368439)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45743405211368442)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45743623963368444)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45743775553368445)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45743898639368446)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45743932108368447)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45744142075368449)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45744252352368450)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(48188374530092132)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(45744004741368448)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(46253212650623938)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(46253913780623952)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(46254012355623952)
,p_name=>'Estado de cuenta'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46254754208623958)
,p_db_column_name=>'ID_FACTURA_VENTA'
,p_display_order=>1
,p_column_identifier=>'A'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46255168449623959)
,p_db_column_name=>'FECHA_FACTURA'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Fecha factura'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46255522894623959)
,p_db_column_name=>'ENT_ID_ENTIDAD'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Id entidad'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46255976854623960)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46256388402623960)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46256784353623960)
,p_db_column_name=>'NRO_FACTURA'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Nro. factura'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46257175698623960)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46257535339623961)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46257935128623961)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46258316691623961)
,p_db_column_name=>'ORDEN_COMPRA'
,p_display_order=>10
,p_column_identifier=>'J'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46258703594623961)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(46259107645623961)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(45741194893368419)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(46259831045628285)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(47935142479522191)
,p_report_id=>wwv_flow_imp.id(46259831045628285)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(45741472223368422)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(45744004741368448)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(45741813765368426)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(40145291469956608)
,p_name=>'P138_ID_LICITACION'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(45744004741368448)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(45740821565368416)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(45741217086368420)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(45741345918368421)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(45740914922368417)
,p_name=>'Set'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45741061444368418)
,p_event_id=>wwv_flow_imp.id(45740914922368417)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(45741670552368424)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(45741907930368427)
,p_process_sequence=>10
