...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(132598350893901873)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(132602474561901876)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(132602902962901876)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(132602474561901876)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(132604245478901877)
...
,p_security_scheme=>wwv_flow_imp.id(132624133368268814)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(132604674518901878)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(132605050338901878)
...
,p_security_scheme=>wwv_flow_imp.id(132623931526267833)
,p_database_action=>'INSERT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(132598642528901873)
,p_name=>'P126_ID_DET_ESPECIALIDAD'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(132598350893901873)
,p_item_source_plug_id=>wwv_flow_imp.id(132598350893901873)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(132599082522901874)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(132599775638901875)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(132600213255901875)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(132600533857901875)
,p_name=>'P126_ESTADO'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(132598350893901873)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(132602937095901876)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(132602902962901876)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(132603783669901877)
,p_event_id=>wwv_flow_imp.id(132602937095901876)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(132605835080901878)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(132598350893901873)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(132606235604901878)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(132605503310901878)
,p_process_sequence=>10
