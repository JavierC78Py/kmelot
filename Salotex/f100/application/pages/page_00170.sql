...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(49575175847327023)
...
,p_parent_plug_id=>wwv_flow_imp.id(49575175847327023)
...
wwv_flow_imp_page.create_ig_report_highlight(
 p_id=>wwv_flow_imp.id(177750000004)
,p_view_id=>wwv_flow_imp.id(49561697090295800)
,p_execution_seq=>5
,p_name=>'INACTIVO'
,p_background_color=>'#ffd6d2'
,p_condition_type=>'COLUMN'
,p_condition_column_id=>wwv_flow_imp.id(49569247684295809)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(49575220110327024)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(49575487771327026)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(49575530608327027)
,p_name=>'REC_ID_RECETA'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'REC_ID_RECETA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(49575624427327028)
...
,p_is_required=>true
,p_lov_type=>'SHARED'
,p_lov_id=>wwv_flow_imp.id(132620124778091696)
,p_lov_display_extra=>false
,p_lov_display_null=>true
,p_lov_null_text=>'-- Seleccione'
,p_enable_filter=>true
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(49575752474327029)
,p_name=>'APEX$ROW_ACTION'
,p_item_type=>'NATIVE_ROW_ACTION'
,p_display_sequence=>20
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(49575846197327030)
,p_name=>'APEX$ROW_SELECTOR'
,p_item_type=>'NATIVE_ROW_SELECTOR'
,p_display_sequence=>10
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(49575373716327025)
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(52445116214642840)
,p_interactive_grid_id=>wwv_flow_imp.id(49575373716327025)
,p_static_id=>'524452'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(52445345304642840)
,p_report_id=>wwv_flow_imp.id(52445116214642840)
,p_view_type=>'GRID'
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
,p_edit_mode=>false
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(52445856209642844)
,p_view_id=>wwv_flow_imp.id(52445345304642840)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(49575487771327026)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(52446791043642846)
,p_view_id=>wwv_flow_imp.id(52445345304642840)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(49575530608327027)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(52447609444642848)
,p_view_id=>wwv_flow_imp.id(52445345304642840)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(49575624427327028)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(52449972179659913)
,p_view_id=>wwv_flow_imp.id(52445345304642840)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(49575752474327029)
,p_is_visible=>true
,p_is_frozen=>false
);
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(49575950347327031)
,p_process_sequence=>55
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(49575220110327024)
,p_process_type=>'NATIVE_IG_DML'
