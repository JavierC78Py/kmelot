...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(86262876569327418)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(86329277781670947)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(86329338012670948)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(86329463178670949)
...
,p_rpt_named_lov=>wwv_flow_imp.id(85944030468257182)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(86329599110670950)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(86329648130670951)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(86329807063670952)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(86329835435670953)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(86329950056670954)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(86330082003670955)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(86355382196673533)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(40155507180359802)
,p_report_id=>wwv_flow_imp.id(86355382196673533)
,p_name=>'Upd NO'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(40155964287359802)
,p_report_id=>wwv_flow_imp.id(86355382196673533)
,p_name=>'Upd'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(40156356576359802)
,p_report_id=>wwv_flow_imp.id(86355382196673533)
,p_name=>'Del NO'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(40156774301359803)
,p_report_id=>wwv_flow_imp.id(86355382196673533)
,p_name=>'Del'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(40157168525359803)
,p_report_id=>wwv_flow_imp.id(86355382196673533)
,p_name=>'Ins NO'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(40157564402359803)
,p_report_id=>wwv_flow_imp.id(86355382196673533)
,p_name=>'Ins'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(86271925246327432)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(86262876569327418)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(86272226454327432)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(86262876569327418)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(86272789337327434)
,p_event_id=>wwv_flow_imp.id(86272226454327432)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(86262876569327418)
,p_attribute_01=>'N'
);
