...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(209434763471094843)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(209441318001094870)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(209441776724094871)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(209441318001094870)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(209443319943094877)
...
,p_security_scheme=>wwv_flow_imp.id(205642108017732608)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(209443721928094877)
...
,p_button_condition=>'P13_ID_CONTACTO_ENTIDAD'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(205641870458731649)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(209444115644094878)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209435184337094846)
,p_name=>'P13_ID_CONTACTO_ENTIDAD'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(209434763471094843)
,p_item_source_plug_id=>wwv_flow_imp.id(209434763471094843)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209435511693094853)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209435854618094859)
,p_name=>'P13_NOMBRE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209436258049094859)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209436671103094860)
,p_name=>'P13_TELEFONO'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(209434763471094843)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209437077273094861)
,p_name=>'P13_CORREO'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(209434763471094843)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209437483770094862)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209437804097094863)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(209438260831094863)
,p_name=>'P13_ESTADO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>90
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(209441897747094871)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(209441776724094871)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(209442633236094874)
,p_event_id=>wwv_flow_imp.id(209441897747094871)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(209444981536094881)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(209434763471094843)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(209445330154094881)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(209444548459094880)
,p_process_sequence=>10
