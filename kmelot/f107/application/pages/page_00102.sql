...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(675148589011444028)
,p_plug_name=>'Flujos'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(675148690993444029)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(218342505927762396)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(675148690993444029)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(207269499245772206)
,p_name=>'Inicio'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(207269553076772207)
,p_event_id=>wwv_flow_imp.id(207269499245772206)
,p_event_result=>'TRUE'
