...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(209638627198108180)
...
'       P.PRODUCTO_CODIGO,',
'       (',
'        SELECT listagg(pt.tamanho,'','') within group (ORDER BY pt.tamanho) ',
'        FROM producto_tamanho pt',
'        WHERE pt.pro_id_producto = P.ID_PRODUCTO',
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(209639020847108181)
,p_name=>'Report 1'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209639154004108181)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209639569640108182)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209639975012108182)
...
,p_rpt_named_lov=>wwv_flow_imp.id(209647451332117600)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209640390854108183)
...
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(209647655683120949)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209640727272108184)
...
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(209647866809125814)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209641178313108184)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209641563795108185)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209641941764108185)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209642322376108186)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209642748134108186)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209643192308108187)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209643598204108188)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209643960484108188)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209644324201108189)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209644786158108189)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(203767677210482789)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(203767748388482790)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(203767922425482791)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(203767991245482792)
...
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_imp.id(201154627923493815)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(203768208523482794)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(207946449148431679)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(153778671109841475)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(168713038274239779)
,p_db_column_name=>'TAMANHOS'
,p_display_order=>96
,p_column_identifier=>'Y'
,p_column_label=>unistr('Tama\00F1os')
,p_column_type=>'STRING'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(209652393230193318)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'65764'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'ID_PRODUCTO:DESCRIPCION:STOCK:ORI_ID_ORIGEN:MAR_ID_MARCA:IVA_ID_IVA:CODIGO_BARRA_FABRICA:CODIGO_BARRA_INTERNO:ESTADO:GRUPO_NIVEL_1:GRUPO_NIVEL_2:GRU_ID_GRUPO:STOCK_MINIMO:TAMANHOS:'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(209645778421108191)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(209646921366108193)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(209638627198108180)
