...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(261647105152877167)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(261651592633877184)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(253496898193162764)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(261651592633877184)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(253497329715162764)
...
,p_security_scheme=>wwv_flow_imp.id(253508261514624704)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(253497646742162764)
...
,p_button_condition=>'P133_ID_GRUPO'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(253507928550622646)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(253498105245162764)
...
,p_security_scheme=>wwv_flow_imp.id(253508054779623833)
,p_database_action=>'INSERT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(261624885194882571)
,p_name=>'P133_NIVEL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(261647105152877167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(261648131244877169)
,p_name=>'P133_ID_GRUPO'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(261647105152877167)
,p_item_source_plug_id=>wwv_flow_imp.id(261647105152877167)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(261648455345877179)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(261648835545877181)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(261649242433877182)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(261649652494877182)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(261650079023877182)
,p_name=>'P133_ESTADO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>70
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(312390668326541787)
,p_name=>'P133_TIPO'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(261647105152877167)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(253499528023162765)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(253496898193162764)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(253499997841162765)
,p_event_id=>wwv_flow_imp.id(253499528023162765)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(253503267387162767)
,p_name=>'Desactivar'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(253503779986162768)
,p_event_id=>wwv_flow_imp.id(253503267387162767)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(253500401812162766)
,p_name=>'Habilitar'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(253500900983162766)
,p_event_id=>wwv_flow_imp.id(253500401812162766)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(253502943362162767)
,p_event_id=>wwv_flow_imp.id(253500401812162766)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(253501908476162767)
,p_event_id=>wwv_flow_imp.id(253500401812162766)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(253502371842162767)
,p_event_id=>wwv_flow_imp.id(253500401812162766)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(253501391808162766)
,p_event_id=>wwv_flow_imp.id(253500401812162766)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(253496169146162763)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(261647105152877167)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(253498659792162765)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(253495791736162762)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(253499079957162765)
