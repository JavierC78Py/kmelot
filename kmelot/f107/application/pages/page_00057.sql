...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(206602497678498870)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(206607030261498885)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(206607412484498886)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(206607030261498885)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(206608791016498894)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(206609159049498894)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(206609580552498894)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(202344772612274179)
,p_name=>'P57_CON_ID_CONCEPTO'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(206602497678498870)
,p_item_source_plug_id=>wwv_flow_imp.id(206602497678498870)
,p_prompt=>'Concepto'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(206602814871498872)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(206603235187498879)
,p_name=>'P57_TIPO'
...
,p_lov=>'.'||wwv_flow_imp.id(206074964432490220)||'.'
,p_lov_display_null=>'YES'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(206603977958498882)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(206604413999498882)
,p_name=>'P57_PERIODO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(206604835097498883)
,p_name=>'P57_ESTADO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>70
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(206607467723498886)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(206607412484498886)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(206608326422498893)
,p_event_id=>wwv_flow_imp.id(206607467723498886)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(206610425361498898)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(206602497678498870)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(206610809047498898)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(206609955276498896)
,p_process_sequence=>10
