...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(253693024515456149)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(253699887064456154)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(253700326842456154)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(253699887064456154)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(253701729752456155)
...
,p_security_scheme=>wwv_flow_imp.id(253782251662133507)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(253702107205456155)
...
,p_button_condition=>'P137_ID_PARAMETRO_RESERVA'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(253781908127131504)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(253702482210456156)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(251867905489041925)
,p_name=>'P137_SUC_ID_SUC_ENTIDAD'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(253693024515456149)
,p_item_source_plug_id=>wwv_flow_imp.id(253693024515456149)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253693299366456150)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253693699457456150)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253694437833456151)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253694821219456151)
,p_name=>'P137_NRO_DIA'
...
,p_lov=>'.'||wwv_flow_imp.id(253714851149537620)||'.'
,p_cHeight=>5
,p_field_template=>1609121967514267634
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253695228624456151)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253695575807456151)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253695965464456152)
,p_name=>'P137_ESTADO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>50
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253696412638456152)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(253696782011456152)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(253700437800456154)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(253700326842456154)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(253701192166456155)
,p_event_id=>wwv_flow_imp.id(253700437800456154)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(251866714536041913)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(253703334840456156)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(253693024515456149)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(253703690212456156)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(253702855996456156)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(251866835528041914)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
