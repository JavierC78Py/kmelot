...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(218363072917430277)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(218369600295430291)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(218370030063430291)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(218369600295430291)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(218371433133430293)
...
,p_security_scheme=>wwv_flow_imp.id(232541630069162627)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(218371771412430293)
...
,p_button_condition=>'P97_ID_DESCUENTO'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(232541200107164636)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(218372242435430294)
...
,p_security_scheme=>wwv_flow_imp.id(232541350356163479)
,p_database_action=>'INSERT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218310975398551919)
,p_name=>'P97_MON_ID_MONEDA'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(218363072917430277)
,p_item_source_plug_id=>wwv_flow_imp.id(218363072917430277)
,p_prompt=>'Moneda'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218363354020430278)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218363675048430283)
,p_name=>'P97_ESTADO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218364049159430284)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218364495880430286)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218364863486430286)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218365326441430287)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218365740198430287)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218366107496430287)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(218366488179430288)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(218310236152551911)
...
,p_associated_item=>wwv_flow_imp.id(218366488179430288)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(218370138312430291)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(218370030063430291)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(218370862164430293)
,p_event_id=>wwv_flow_imp.id(218370138312430291)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(218373026592430296)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(218363072917430277)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(218373383936430297)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(218372638194430295)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(218310132158551910)
