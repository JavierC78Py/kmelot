...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(203933462708960391)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(203937319014960408)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(203946797473960458)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(203937689944960408)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(203937319014960408)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(203939246402960413)
...
,p_security_scheme=>wwv_flow_imp.id(205862544088514652)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(203939692544960413)
...
,p_button_condition=>'P35_ID_COLABORADOR'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(205862106031512474)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(203940141798960414)
...
,p_security_scheme=>wwv_flow_imp.id(205862280199513555)
,p_database_action=>'INSERT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(203933759957960396)
,p_name=>'P35_ID_COLABORADOR'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(203933462708960391)
,p_item_source_plug_id=>wwv_flow_imp.id(203933462708960391)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(203934165986960403)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(203934549282960406)
,p_name=>'P35_ESTADO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(203934974281960406)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(203935394214960406)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(203937813304960408)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(203937689944960408)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(203938601640960411)
,p_event_id=>wwv_flow_imp.id(203937813304960408)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(203940897235960416)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(203933462708960391)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(203941313936960416)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(203940526078960415)
,p_process_sequence=>10
