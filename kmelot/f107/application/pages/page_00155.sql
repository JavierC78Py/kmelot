...
,p_required_role=>wwv_flow_imp.id(145208458334664082)
,p_dialog_chained=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(144987660909075001)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(144994303916075005)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(145222102967903262)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(144994712554075005)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(144994303916075005)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(144996086847075005)
...
,p_security_scheme=>wwv_flow_imp.id(145209079260667146)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(144996431484075006)
...
,p_button_condition=>'P155_ID_REGISTRO_COMISION'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(145208688491665434)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(144996852948075006)
...
,p_security_scheme=>wwv_flow_imp.id(145208885932666331)
,p_database_action=>'INSERT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144987941217075002)
,p_name=>'P155_ID_REGISTRO_COMISION'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(144987660909075001)
,p_item_source_plug_id=>wwv_flow_imp.id(144987660909075001)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144988358377075002)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144988761472075002)
...
,p_lov=>'.'||wwv_flow_imp.id(145009122754138687)||'.'
,p_lov_display_null=>'YES'
,p_lov_null_text=>'-- Seleccione'
,p_cHeight=>1
,p_colspan=>6
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144989143859075002)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144989605063075003)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144990014251075003)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144990326488075003)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144990738053075003)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144991208881075003)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(145222174378903263)
,p_name=>'P155_P_MONTO_LICITACION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(145222102967903262)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(145222592139903267)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(144994738505075005)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(144994712554075005)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(144995568007075005)
,p_event_id=>wwv_flow_imp.id(144994738505075005)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(139573601953728576)
,p_name=>'Habilitar'
,p_event_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139573681851728577)
,p_event_id=>wwv_flow_imp.id(139573601953728576)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(145222682861903268)
,p_event_id=>wwv_flow_imp.id(139573601953728576)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139573952620728580)
,p_event_id=>wwv_flow_imp.id(139573601953728576)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139574145861728582)
,p_event_id=>wwv_flow_imp.id(139573601953728576)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139573920320728579)
,p_event_id=>wwv_flow_imp.id(139573601953728576)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139574038195728581)
,p_event_id=>wwv_flow_imp.id(139573601953728576)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(139574315355728583)
,p_event_id=>wwv_flow_imp.id(139573601953728576)
,p_event_result=>'FALSE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(145222375101903265)
,p_name=>'SetValor'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(145222472590903266)
,p_event_id=>wwv_flow_imp.id(145222375101903265)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(145222809108903269)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(144997711551075006)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(144987660909075001)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(144998067593075006)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(144997245404075006)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(139573476315728575)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
