...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(206382794448406545)
...
'    and time_stamp >= current_date - ( 1/24/60/60 * :P10033_TIMEFRAME )',
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(206383568433406551)
...
,p_owner=>'JAVIER'
,p_internal_uid=>3307566762171553
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206383648518406565)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206384053821406567)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206384472207406569)
,p_db_column_name=>'MEDIAN_ELAPSED'
,p_display_order=>35
,p_column_identifier=>'C'
,p_column_label=>'Media Transcurrida'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206384864952406570)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206385243140406571)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206385650356406572)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206386021350406573)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206386468751406574)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206386863361406576)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206387233364406577)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206387624423406578)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206388084646406579)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206388443736406580)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(206388867813406581)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(206389542619406582)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'33136'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(206382892286406545)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(206390474408406584)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(206382794448406545)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(206382642907406545)
,p_name=>'P10033_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(206382892286406545)
,p_item_default=>'900'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(206382964551406545)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(206391731015406588)
,p_event_id=>wwv_flow_imp.id(206382964551406545)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(206382794448406545)
,p_attribute_01=>'N'
);
