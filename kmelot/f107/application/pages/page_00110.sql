...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(300670236767936169)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(300670306432936169)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(299838235267126502)
,p_plug_name=>'Qr'
,p_parent_plug_id=>wwv_flow_imp.id(300670306432936169)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(300670414330936169)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(242410459989556240)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(300670414330936169)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(242410930886556239)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(242411308499556239)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(242418249025556234)
,p_branch_name=>'Go To Page 100'
,p_branch_action=>'f?p=&APP_ID.:100:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(242411308499556239)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(184574978598231080)
,p_name=>'P110_ID_SUCURSAL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(300670306432936169)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208764611140255680)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299838419175126492)
,p_name=>'P110_KEY'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(300670306432936169)
,p_prompt=>'P110_KEY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299838737766126495)
,p_name=>'P110_QR_B64'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(300670306432936169)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(299839422016126502)
,p_name=>'P110_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(300670306432936169)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(300753282756195769)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(300753358932195770)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(301070637833475955)
,p_name=>'P110_SCANNED'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(300670306432936169)
,p_item_default=>'0'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(242413862209556237)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(242410459989556240)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(242414392965556236)
,p_event_id=>wwv_flow_imp.id(242413862209556237)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(242414785211556236)
,p_name=>'getQr'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(242415280595556236)
,p_event_id=>wwv_flow_imp.id(242414785211556236)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(242417770720556234)
,p_event_id=>wwv_flow_imp.id(242414785211556236)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(242417292723556234)
,p_event_id=>wwv_flow_imp.id(242414785211556236)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(242416257560556235)
,p_event_id=>wwv_flow_imp.id(242414785211556236)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(184577723067231107)
,p_name=>'Fin'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(242410930886556239)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(184577847293231108)
,p_event_id=>wwv_flow_imp.id(184577723067231107)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CLOSE_REGION'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(300670306432936169)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(242412741603556237)
...
,p_process_when_button_id=>wwv_flow_imp.id(242410930886556239)
,p_process_when_type=>'NEVER'
,p_internal_uid=>49446196967893359
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(242411913374556239)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(242413046576556237)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(242413445071556237)
,p_process_sequence=>20
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'saveInstance'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(242412263937556238)
