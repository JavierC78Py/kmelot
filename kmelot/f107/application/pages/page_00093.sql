...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(214507584534712758)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(214515850759712771)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(214516258885712771)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(214515850759712771)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(214517665926712774)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(214518059650712775)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(214518477958712775)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214507923434712759)
,p_name=>'P93_ID_COLA_MENSAJE'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(214507584534712758)
,p_item_source_plug_id=>wwv_flow_imp.id(214507584534712758)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214508325488712763)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214508998354712766)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214509442886712766)
,p_name=>'P93_MENSAJE'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>60
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214509817250712766)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214510195173712767)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214510623204712767)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214510973537712767)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214511377897712768)
,p_name=>'P93_USUARIO'
,p_source_data_type=>'VARCHAR2'
,p_is_query_only=>true
,p_item_sequence=>110
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214511841298712768)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(214512240190712768)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(214516362009712771)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(214516258885712771)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(214517170157712773)
,p_event_id=>wwv_flow_imp.id(214516362009712771)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(214519294871712776)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(214507584534712758)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(214519679962712776)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(214518856625712776)
,p_process_sequence=>10
