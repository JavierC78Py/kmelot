...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(208331667309047213)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(208335500538047216)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(208335943699047216)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(208335500538047216)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(208337313836047220)
...
,p_security_scheme=>wwv_flow_imp.id(208398485740563090)
,p_database_action=>'DELETE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(208337698421047220)
...
,p_button_condition=>'P82_ID_RENDICION_CAJA'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_security_scheme=>wwv_flow_imp.id(208398067109561332)
,p_database_action=>'UPDATE'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(208338102692047220)
...
,p_security_scheme=>wwv_flow_imp.id(208398257141562172)
,p_database_action=>'INSERT'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(153779411404841482)
,p_name=>'P82_ESTADO'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(208331667309047213)
,p_item_source_plug_id=>wwv_flow_imp.id(208331667309047213)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208332032058047214)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208332409538047214)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208332781930047214)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208333190550047215)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(208333591640047215)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(208336039681047216)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(208335943699047216)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(208336764522047220)
,p_event_id=>wwv_flow_imp.id(208336039681047216)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(208372282527078380)
...
,p_process_when_button_id=>wwv_flow_imp.id(208338102692047220)
,p_internal_uid=>15405737891415502
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(153779515723841483)
...
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(208337698421047220)
,p_internal_uid=>34545990152185345
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(208338865833047221)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(208331667309047213)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(208339291276047221)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(208338525725047220)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(208372210923078379)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
