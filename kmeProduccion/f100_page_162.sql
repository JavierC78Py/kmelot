...
/
prompt --application/pages/delete_00162
begin
wwv_flow_imp_page.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>162);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(124661257716561236)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(124661373765561236)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35474059660696042)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(126653358408410962)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35474169165696043)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(126653209057410961)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(124665694147561245)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(124666180579561245)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35474279298696044)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35474325649696045)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(124666895506561245)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(124667340970561246)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(124672270811633558)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(124669527464561250)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(39538809450009558)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(124661257716561236)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(39540188334009573)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(124661257716561236)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(39540687125009575)
,p_event_id=>wwv_flow_imp.id(39540188334009573)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(124661257716561236)
,p_attribute_01=>'N'
);
end;
/
